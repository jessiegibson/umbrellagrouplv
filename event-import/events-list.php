...
<div class="container-fluid header">
    ...
    <div class="container" id="main-content">
        ...
        <div>
			...
			?>
            	<div class="clearfix">
                	<div class="col-md-3"><a href="event-detail/<?php echo $event['event_id'] ?>/<?php echo $event['event_name'] ?>/<?php echo $event['venue'] ?>/<?php echo $event['event_date'] ?>"><img src="<?php echo $image?>" width="200" /></a></div>
                	<div><b><a href="event-detail/<?php echo $event['event_id'] ?>/<?php echo $event['event_name'] ?>/<?php echo $event['venue'] ?>/<?php echo $event['event_date'] ?>"><?php echo $event['event_name']?></a></b></div>
                    <div><i><?php echo date('M d, Y @H:i:A', strtotime($event['event_date']))?></i></div>
